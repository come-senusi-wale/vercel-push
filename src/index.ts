...
import adminNotificationRoute from "./features/api/admin/notification/notification.route";
...
app.use("/api/v1/admin", [adminRoute, adminAthleteRoute, adminScoutRoute, adminTrialRoute, adminNotificationRoute]);
