...
const index_2 = __importDefault(require("../../../../shared/services/database/general/notification/index"));
const user_middleware_1 = require("../../../../shared/services/middleware/user.middleware");
const index_3 = __importDefault(require("../../../../shared/services/database/athletes/trialApplication/index"));
...
const trialApplicationModel = new index_3.default();
const notificationModel = new index_2.default();
...
router.post("/trials/apply", user_middleware_1.isAthleteAuthenticated, (0, fileUpload_middleware_1.singleFileUpload)('picture', ['image', 'video']), trial_validation_1.AthleteTrialValidation.applyTrial, trial_validation_1.AthleteTrialValidation.validateFormData, trialController.applyForTrial);
